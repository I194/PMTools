...
const updateOptions = {
    gitRepo: "PMTools", // [Required] Your Repo Name
    gitUsername: "I194",  // [Required] Your GitHub Username.

    appName: "PMTools beta", //[Required] The Name of the app archive and the app folder.
    appExecutableName: "PMTools.exe", //[Required] The Executable of the Application to be Run after updating.
